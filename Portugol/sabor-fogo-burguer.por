programa {
  funcao inicio() {
    ...
    inteiro menu, linha_p = 0, coluna_p = 0, aux, linha_s = 0, coluna_s = 0, linha_g = 0, coluna_g = 0, opc, mpag, mvenda, cod_h, vendas[linha_s], valor, valor_t = 0, quant

    cadeia produtos[9][3], sabores[6][3], gasto_ing[9][6]
    ...
    faca{
      ...
      escolha(menu){
        ...
        caso 3:{
          ...
          faca{
            ...
            para(aux = 0; aux < linha_s; aux++){
              se( cod_h == produtos[aux][2]){
                  vendas[aux]++
                  valor_t += sabores[aux][2]
              }
            }
          ...
          escreva("Valor total: "+valor_t * quant)
        ...
        para(aux = 0; aux < linha_g; aux++){
          produto[aux][0] -= gasto_ing[aux][0]
        }

        para(aux = 0; aux < linha_p; aux++){
            escreva(""+produtos[aux])
        }
